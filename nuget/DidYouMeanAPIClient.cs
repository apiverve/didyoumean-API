...
namespace APIVerve.API.DidYouMean
{
    ...
    /// <summary>
    /// Client for the DidYouMean API
    /// </summary>
    public class DidYouMeanAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/didyoumean";
        ...
        public DidYouMeanAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public DidYouMeanAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public DidYouMeanAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, DidYouMeanQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(DidYouMeanQueryOptions options)
        {
        ...
        public ResponseObj Execute(DidYouMeanQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(DidYouMeanQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(DidYouMeanQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(DidYouMeanQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(DidYouMeanQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(DidYouMeanQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(DidYouMeanQueryOptions options)
        {
