...
[![RubyGems](https://img.shields.io/badge/RubyGems-E9573F?style=flat&logo=rubygems&logoColor=white)](https://rubygems.org/gems/apiverve_didyoumean)
[![Packagist](https://img.shields.io/badge/Packagist-F28D1A?style=flat&logo=packagist&logoColor=white)](https://packagist.org/packages/apiverve/didyoumean)
[![Go](https://img.shields.io/badge/Go-00ADD8?style=flat&logo=go&logoColor=white)](#-go)
[![Dart](https://img.shields.io/badge/Dart-0175C2?style=flat&logo=dart&logoColor=white)](https://pub.dev/packages/apiverve_didyoumean)
...
```bash
curl -X GET "https://api.apiverve.com/v1/didyoumean?query=what%20weather%20today%20is" \
...
```bash
gem install apiverve_didyoumean
```

[**View RubyGems Package →**](https://rubygems.org/gems/apiverve_didyoumean) | [**Package Code →**](./ruby/)
...
[**View Packagist Package →**](https://packagist.org/packages/apiverve/didyoumean) | [**Package Code →**](./php/)
...
```bash
dart pub add apiverve_didyoumean
```

[**View pub.dev Package →**](https://pub.dev/packages/apiverve_didyoumean) | [**Package Code →**](./dart/)
...
A real response from the Did You Mean API:
