...
class didyoumeanWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/didyoumean');
        }
        ...
        this.validationRules = {"query":{"type":"string","required":true}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/didyoumean`);
        }
    }
...
module.exports = didyoumeanWrapper;
