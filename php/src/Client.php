...
/**
 * Client for the Did You Mean API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/didyoumean?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/didyoumean';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\DidyoumeanClient] {$message}\n";
        }
    }
}
