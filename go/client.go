// Package didyoumean provides a Go client for the Did You Mean API.
//
// For more information, visit: https://apiverve.com/marketplace/didyoumean?utm_source=go&utm_medium=readme
package didyoumean
...
const (
	baseURL        = "https://api.apiverve.com/v1/didyoumean"
	defaultTimeout = 30 * time.Second
)

// Client is the Did You Mean API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Did You Mean API client.
...
// Execute makes a request to the Did You Mean API with typed parameters.
//
...
//   - query (required): string - The text you want to check for spelling mistakes
