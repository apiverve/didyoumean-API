...
```gradle
dependencies {
    implementation 'com.github.apiverve:didyoumean-api:1.1.14'
}
```
...
```java
import com.apiverve.didyoumean.DidYouMeanAPIClient;
import com.apiverve.didyoumean.APIResponse;
import com.apiverve.didyoumean.APIException;

// Initialize the client
DidYouMeanAPIClient client = new DidYouMeanAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("query", "what weather today is");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/didyoumean](https://docs.apiverve.com/ref/didyoumean)
...
- **Documentation:** [https://docs.apiverve.com/ref/didyoumean](https://docs.apiverve.com/ref/didyoumean)
- **Issues:** [GitHub Issues](https://github.com/apiverve/didyoumean-api/issues)
